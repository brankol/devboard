...
class CommitAuthorFactorySpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('DevBoard\GithubRemote\Fetch\Branch\Data\CommitAuthorFactory');
    }

    public function it_will_create_remote_commit_author_value_object(GithubBranchData $githubBranchData)
    {
        $data = [
            'commit' => [
                'author' => [
